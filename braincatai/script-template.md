...
> **Правило (locked 28 мая 2026):** тумбнейл-промт ВСЕГДА живёт в собственной видной секции `## 🖼️ ТУМБНЕЙЛ` — НЕ закопан внутри SEO Pack. Применяет «5 Signs» формулу (текущий лучший CTR): крупный план лица 60% + dilated глаза в зрителя + ОДИН hook-объект + желтая плита + короткий броский текст (≤3-4 слова/строка) + emoji.
