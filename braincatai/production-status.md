...
🕒 **Locked publish slot (1 июн 2026, user-validated): 15:00 (local TZ).** Это был исторический слот ДО падения трафика — Giant (44 views, 15 мая) и предыдущие 50+ просмотровые шортсы выходили именно в 15:00. Алгоритм YouTube помнит этот таймслот по тем видео которые тогда заходили. Возврат на 15:00 = восстановление паттерна аудитория-активна-в-этот-час, а НЕ отклонение. **Все шортсы recovery-фазы публикуем в 15:00 локального TZ.** Если временный сдвиг (technical / personal) — окно ±30 мин допустимо, но не выходить за 14:30-15:30.
