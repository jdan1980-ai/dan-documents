...
The cat should *react* (surprised, smug, confused, "aha!") to keep retention. Use the cat as the audience surrogate.

---

## 1. Science & Space

1. Why is the sky blue? (cat looking up, confused)
2. What's inside a black hole? (cat sucked into void)
3. How do magnets actually work? (cat stuck to fridge)
4. Why does time slow down near light speed? (cat in spaceship)
5. What would happen if Earth stopped spinning? (cat flying off)
6. Why is space cold but the Sun hot? (cat in spacesuit)
7. How big is the universe? (cat zooming out)
8. Why do we dream? (sleepy cat, REM eyes)
9. Why does ice float? (cat on iceberg)
10. What is dark matter? (cat looking for invisible mouse)

## 2. Animals & Biology

11. Why do cats purr? (meta — cat explaining itself)
12. How do octopuses see color if they're colorblind?
13. Why do we yawn? (cat yawning chain reaction)
24. What if humans had tails? (cat with extra-long tail)
14. Why are cats afraid of cucumbers? (the real reason)
15. How does a chameleon change color?
16. Why do flamingos stand on one leg?
17. What's the smartest animal? (cat insulted by ranking)
18. Can fish drown?
19. Why don't woodpeckers get headaches?

## 3. Math & Logic (visual-friendly)

20. The Monty Hall problem (3 doors, 3 cats)
21. Why 0.999... = 1 (cat refuses to believe it)
22. Infinity is bigger than infinity (Hilbert's hotel of cats)
23. The birthday paradox (room of cat clones)
24. Why pi shows up everywhere (cat measuring circles)
25. Fibonacci spirals in nature (cat curled in spiral)
26. How big is a googol? (cat counting forever)

## 4. Psychology & Brain

27. Why you forget what you came into a room for (doorway effect)
28. The Dunning-Kruger effect (overconfident cat)
29. Why time flies when you're having fun
30. The bystander effect (10 cats watching, no one helps)
31. Why music gives you goosebumps
32. Why we cry when we're happy
33. The placebo effect (sugar treat works on cat)

## 5. AI & Tech (your meta-niche)

34. How does ChatGPT actually work? (cat typing)
35. What is a neural network? (cat brain diagram)
36. Will AI take your job? (robot cat vs real cat)
37. How do AI images get made? (cat generating cats)
38. The Turing test explained
39. Why GPUs train AI, not CPUs (gamer cat)
40. What is a token? (cat eating word-cookies)

## 6. History (quick & weird)

41. Why Romans drank lead (and went mad)
42. The shortest war in history (38 minutes)
43. Cleopatra lived closer to the Moon landing than to the pyramids
44. Vikings didn't actually wear horned helmets
45. The Great Emu War of 1932 (cats vs emus visual)
46. Napoleon was actually average height

## 7. "Did You Know" Mind-Blowers

47. Bananas are radioactive
48. Honey never spoils
49. Sharks existed before trees
50. Your stomach gets a new lining every few days
51. There are more trees on Earth than stars in the Milky Way
52. Octopuses have 3 hearts and blue blood
53. A day on Venus is longer than its year

## 8. Series Ideas (recurring formats)

- **"Cat Asks Why"** — 1 question, 1 answer, every Monday
- **"Smart Cat / Dumb Cat"** — myth vs fact, two cat characters
- **"Cat Explains in 30 Sec"** — speed-run a complex topic
- **"What If…?"** — hypothetical scenarios with cat consequences
- **"Today I Learned"** — daily one-fact uploads

---

## Title Formulas (high-CTR for Shorts)

- `Why [common thing] is actually [surprising truth]`
- `What if [extreme scenario]?`
- `[Number] facts about [topic] that broke my brain`
- `You've been [doing X] wrong your whole life`
- `The reason [thing] exists will shock you`
- `[Famous thing] is a lie. Here's the truth.`

## Hook Lines (first 2 seconds)

- "Cats can't taste sweet. Here's why that matters…"
- "This cat just solved a 200-year-old math problem."
- "99% of people get this wrong."
- "I'm about to ruin your childhood in 30 seconds."
- "Wait — gravity isn't real?"

## Thumbnail Patterns

- Cat with 😱 expression + 1 huge word
- Split screen: cat + the topic (e.g., black hole)
- Cat pointing at giant number/fact
- Use bright color (yellow/red) on edges, not center

---

## Posting Cadence Suggestion

- **Daily** for first 30 days (algorithm boost window)
- Mix categories — don't post 5 space videos in a row
- Reuse top performers as **templates** (same hook style, new topic)
...
4. ~~Какие конкретно эпохи покрыть?~~ → **Все 6 эпох**, по ~2 мин каждая
   ...
   - 🦷 **Saber-tooth era** (2.5 млн) — Smilodon, охота, вымирание
   - 🌍 **Cats spread across the planet** — лев/тигр/гепард, common ancestors
   - 🏺 **Egyptian domestication** (10K лет) — коты одомашнили себя
   - 🏠 **Modern breeds + DNA** — Victorian селекция, генетика окрасов
   - 🧬 **Future of cats** — DNA studies, что дальше
5. **Visual budget mix на 15 мин (~180 ассетов):**
   - **Veo 3 animated clips:** ~50–60 шт × 5–8 сек (Brain в action/костюмах/реакциях)
   - **Still images** (Nano Banana): ~50–60 шт × 4–6 сек + Ken Burns zoom в Google Vids
   - **Motion graphics** (Google Vids): ~20 шт × 5–8 сек (карты, family tree, графики)
   - **Stock B-roll** (Pexels/Pond5): ~10–15 шт × 4–5 сек (природа, древний Египет, DNA)
...
### Структура 15-мин видео — 6 эпох (без глав)

> Каждая эпоха получает ~2 минуты = ~250 слов VO = ~5–7 визуальных битов. Документальное дыхание, можно разворачивать драму.

| Время | Beat | Что |
|-------|------|-----|
| 0:00–0:30 | **Cold open hook** | "Your house cat is a 45-million-year-old killing machine" — Brain в современной комнате, реакция шок |
| 0:30–1:00 | **Setup + промис** | Brain показывает family tree, "за 15 минут — путь от древних хищников до твоего кота на диване" |
| 1:00–3:00 | **Эпоха 1: Proailurus** (2 мин) | Древесный хищник 45 млн лет, размер с кошку, лазал по деревьям, Brain в "prehistoric" окружении |
| 3:00–5:00 | **Эпоха 2: Saber-tooths** (2 мин) | Smilodon, 18-см зубы, охота на мамонтов, Ice Age экосистема, вымирание ~10К лет назад |
| 5:00–5:20 | **Mid-roll hook #1** | "Но самое странное — твой кот до сих пор охотится как они. И вот почему..." |
| 5:20–7:20 | **Эпоха 3: Cats spread the planet** (2 мин) | Льв/тигр/гепард — все от общего предка, миграция через континенты, разные ниши хищников |
| 7:20–9:30 | **Эпоха 4: Egyptian domestication** (2 мин 10 сек — anchor) | Bastet, храмы, коты пришли сами в зернохранилища ловить мышей, "одомашнили себя", обожествление |
| 9:30–9:50 | **Mid-roll hook #2** | "А твой современный кот считает тебя своим..." |
| 9:50–11:50 | **Эпоха 5: Modern breeds** (2 мин) | Викторианский кот-шоу 1871, селекция, генетика окрасов (orange = boy, calico = girl), породы |
| 11:50–13:30 | **Эпоха 6: Future of cats** (1 мин 40 сек) | DNA studies, генетическая память от Smilodon, гибриды, что дальше для эволюции |
| 13:30–14:30 | **Payoff + emotional close** (1 мин) | Brain в современной комнате с любым зрителем-котом — "тот самый 45-миллионнолетний хищник теперь спит у тебя на коленях", emotional connection |
| 14:30–15:00 | **CTA + end screen** | Subscribe + watch next link, "если понравилось — смотри [next video]" |

**Что нужно для production-старта:**
- ✅ Решено: 15 мин, все 6 эпох, TTS, без глав
- ⏳ Нужны новые костюмы Brain в style-guide §2 (Smilodon, Egyptian, Victorian, Migrant/Explorer, Geneticist) + locations для эпох
- ⏳ Полный VO script (~1700–2000 слов на 15 мин)
- ⏳ Список ~180 ассетов разбитых по эпохам
