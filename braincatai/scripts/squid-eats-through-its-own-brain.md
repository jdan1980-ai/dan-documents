...
## Meta
- **Title (working):** Why Does A Squid Eat Through Its Own Brain 🦑 | Brain's Lab
- **Slug:** `squid-eats-through-its-own-brain`
- **Category:** Did You Know / Brain Hacks (animal facts, pattern interrupt, first-person scientist POV)
...
**INT. BRAIN'S LAB — NIGHT**
```
INT. BRAIN'S LAB — NIGHT. A cozy Pixar-style scientist's laboratory: glass beakers glowing with colored liquids on a wooden workbench, sea-creature diagrams and star charts pinned to the walls, a large holographic projector in the center casting cool blue-purple light, bookshelves stuffed with science tomes, a chalkboard with equations in the background, a small window showing a dark star-filled sky, warm amber desk lamp glow + cool blue holographic light. Academic, curious, slightly magical atmosphere. The holographic projector is the science "screen" for all scientific facts — every fact is shown as a hologram in this room, NOT a separate location.
```
...
SINGLE-CHARACTER RULE (strict): ONLY Brain — no second character, no second cat.
...
```
**🎙️ VO (EN):** Four — it changes color in ONE millisecond. Faster than you can blink.
**🎙️ VO (RU):** Четыре — меняет цвет за одну миллисекунду. Быстрее моргания.
**Оверлей (CapCut):** `4️⃣ 1 MILLISECOND ⚡`
🔊 SFX: camera shutter snap.
...
```
**🎙️ VO (EN):** Five — but it's completely colorblind.
**🎙️ VO (RU):** Пять — но он полностью дальтоник.
**Оверлей (CapCut):** `5️⃣ BUT IT'S COLORBLIND 🤯`
🔊 SFX: comedic mini record-scratch sting.
...
**Title:** `Why Does A Squid Eat Through Its Own Brain 🦑 | Brain's Lab`
_(60 chars ✓)_
...
```
Кальмар Ест Через Свой Мозг — Это Реально 🦑
5 Фактов О Кальмаре Которые Сломают Мозг 🦑
```
...
## Метрики (заполнить после публикации)
| | 48ч | 7д |
|--|--|--|
| CTR (>5%) | | |
| Retention (>50%) | | |
