# Why Cats Slow Blink (And How to Blink Back)
...
The viewer learns what a cat's slow blink actually means AND gets a trick to try with their cat right now.
...
### Location A — `INT. COZY LIVING ROOM — AFTERNOON`
...
And here's the wild part — you can send it back.

In cat language, a long stare means aggression. Cats never hold eye contact with enemies.

But a slow blink says the opposite: I trust you. You're safe.

Scientists tested it. They slow blinked at cats — and the cats slow blinked BACK.

That slow blink is cat for "I love you." They've been saying it for years.

Try it right now. Look at your cat. Slowly... close your eyes.

If they blink back — congratulations. Your cat loves you. Follow Brain for more cat secrets.
```
...
**Beat purpose:** Brain demonstrates the slow blink right in front of the viewer. Hook = the blink itself.
**Location:** A
...
**Beat purpose:** Promise the payoff — viewer can blink back. Make them need to keep watching.
...
TIME 0–2s: Brain sits with wide bright sparkling eyes facing camera, a single small star-sparkle appears in each eye and fades. Tail tip flicks once with energy.

TIME 2–5s: Brain raises ONLY his right front paw and extends it slightly forward toward camera (not upward, but reaching out) in a "presenting the idea" gesture. Left front paw stays on the ground. Both back paws on the ground. Ears fully perked forward.
...
**Beat purpose:** The slow blink = I trust you. Direct contrast to Scene 3.
...
```
SHOT: Static close-up on Brain's face and upper body, eye-level.

TIME 0–2s: Brain looks directly at camera with warm, fully open eyes — calm, relaxed, gentle. Ears softly outward. Tail sweeps slowly once behind him.

TIME 2–6s: Brain performs a slow deliberate blink — eyes close very slowly over 1.5 seconds (the closing feels luxurious and unhurried), hold fully closed for 1 second, then open slowly over 1.5 seconds. Ears stay fully relaxed and slightly outward during the blink. This blink is the opposite of Scene 3 — all softness, no tension.
...
**Beat purpose:** The emotional payoff — the slow blink = I love you. Heart moment.
...
```
SHOT: Static medium close-up, very slow subtle push-in (frame moves 5% closer over the 7 seconds — barely perceptible).

TIME 0–2s: Brain stares at camera with wide sparkling eyes, a gentle warm golden glow begins pulsing softly around his outline, tail curled around front paws.

TIME 2–5s: Brain's round pupils shift to tiny heart shapes for 1.5 seconds — the heart pupils glow softly then return to round. Simultaneously, two small pink hearts rise slowly near his ears, float upward for 1 second, then dissolve into the air.
...
**Beat purpose:** Interactive tutorial — show the viewer exactly how to do it. "Try it right now."
...
```
SHOT: Static medium close-up, eye-level, slightly warmer golden lighting than previous scenes.

TIME 0–2s: Brain looks directly at camera with eyes fully open, warm and inviting expression — as if waiting for the viewer to be ready. Ears gently forward. Tail relaxed.

TIME 2–6s: Brain performs an exaggerated instructional slow blink — eyes close ultra-slowly over 2 full seconds (very deliberate, like demonstrating the motion step by step), hold fully closed for 1 second, then open slowly over 1 second.
...
**Beat purpose:** Warm close + follow CTA. Brain waves, does a closing slow blink.

> **End card:** after Scene 8, append the reusable Brain end card (Thanks For Watching + Like + Subscribe). Use **Short variant (3 sec)** to keep total runtime under 60 sec. See [end-card.md](../end-card.md).
...
TIME 0–2s: Brain faces camera with bright happy eyes, tail doing one slow happy flick. Gold heart tag catches the light once.

TIME 2–5s: Brain raises ONLY his right front paw and gives a gentle friendly wave — two side-to-side motions. Left front paw stays on the ground. Both back paws on the ground.
...
**Alt prompt (for tools with character limits):**

```
Cozy heartfelt piano, soft acoustic guitar, 95 BPM, warm and gentle, builds subtly at midpoint, no vocals, 60 seconds, royalty-free, tender mood.
```
...
6. Append end card (3 sec Short variant from end-card.md)

## Editing Notes

- Hard cuts between all scenes — no dissolves except Scene 5→6 (slow 0.3s dissolve on the emotional pivot)
- Scene 6: very slight warm color grade increase (golden tint +10%) to match the heart moment — do this in Google Vids color correction
- Comments CTA: add pinned comment "Try the slow blink on your cat 👁️ Did they blink back? Tell me below!"
- Push viewers to comment: the interactive nature of this video = high comment potential
