...
> **Если Brain получается серым / не оранжевым** — этот промт усилен на цвет. Цвет шерсти продублирован: в начале (как первая характеристика), в середине описания, и в `FUR COLOR REMINDER (strict)` блоке в конце. Плюс anti-grey/silver/black в negatives.

```
BRIGHT ORANGE TABBY KITTEN — warm vivid orange fur color (orange hex #F2994A like a classic ginger tabby cat, NOT grey, NOT silver, NOT black, NOT white, NOT brown, NOT desaturated). Cute orange tabby kitten named Brain with soft fluffy BRIGHT ORANGE fur (clearly orange, not muted, not greyish), clearly visible darker burnt-sienna tabby stripes running across his back and forehead, warm cream-colored belly and chin, pink nose, long white whiskers. Big round sparkling VIVID EMERALD GREEN eyes (bright pure emerald green iris #3DDC84 — NOT brown, NOT amber, NOT yellow, NOT hazel, NOT golden), small thin round gold-framed glasses always visible on his face, brown leather collar with gold heart-shaped tag engraved "Brain" always visible at his neck. Pixar 3D CARTOON render style (NOT photorealistic, NOT real cat photo, NOT realistic fur texture). NEUTRAL BACKGROUND — soft warm honey-amber bokeh with no identifiable room, gentle out-of-focus warm ambient lighting, no furniture, no walls in focus, soft warm halo around Brain, dreamy peaceful celebratory atmosphere, shallow depth of field. MEDIUM SHOT framing. Brain sits centered facing camera with a warm joyful expression, vivid emerald green eyes bright with affection, one front right paw raised in a friendly mid-wave gesture, the other front paw firmly on the ground, both back paws on the ground (total 4 paws visible), gold heart-shaped collar tag glinting prominently. Tail held in a soft happy upright curl behind him — the tail is also BRIGHT ORANGE with the same darker tabby stripe pattern. FUR COLOR REMINDER (strict): the kitten's fur is unmistakably BRIGHT WARM ORANGE — classic ginger tabby. Background warm bokeh must NOT tint the fur grey or silver. The orange must stay vivid and saturated even in soft warm lighting. Empty negative space at the top of the frame reserved for a per-video text overlay. Brain has 4 paws total — exactly 4.
```

**Negative prompts (Nano Banana) — anti-grey reinforced:**

```
grey cat, grey fur, gray cat, gray fur, silver fur, silver cat, black cat, black fur, white cat, white fur, brown fur cat, dark fur, ash-grey, slate-grey, monochrome cat, desaturated fur, washed-out color, faded fur color, muted orange, pale orange, beige cat, cream cat, tan fur primary, 2D, flat, anime, cel-shaded, photorealistic cat, multiple cats, low quality, blurry, distorted face, extra limbs, extra paws, five legs, six legs, both front paws raised, two paws raised together, missing glasses, missing collar, missing heart tag, watermark, text in image, logo, ugly, scary, aggressive expression, mouth open as if talking, lip-sync, talking cat, mouth movement, chattering, brown eyes, amber eyes, yellow eyes, hazel eyes, golden eyes, dark eyes, brown iris, amber iris, wrong eye color, warm-tinted eyes, identifiable room, specific furniture, kitchen counter, bedroom bed, hallway door, lab equipment, bathroom tile, second cat
```
...
```
SHOT: Static medium shot, eye-level, Brain centered. Slight slow PUSH-IN (~4% closer over 7 seconds). Brain is a BRIGHT ORANGE TABBY KITTEN with vivid orange fur (#F2994A) and darker tabby stripes — NOT grey, NOT silver. Brain has BRIGHT EMERALD GREEN eyes (#3DDC84) — not brown, not amber.
...
FUR COLOR RULE (strict): Brain's fur is BRIGHT WARM ORANGE (#F2994A) with darker burnt-sienna tabby stripes throughout all 7 seconds. NOT grey, NOT silver, NOT black, NOT washed-out. The warm honey-amber bokeh background must NOT tint his fur grey — the orange stays vivid and saturated even under warm light.
...
STYLE: Pixar 3D CARTOON render (not photorealistic), cinematic warm honey-amber bokeh lighting, vertical 9:16, soft depth of field.
```
