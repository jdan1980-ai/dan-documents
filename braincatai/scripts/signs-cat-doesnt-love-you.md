...
- **Title (working):** 5 Signs Your Cat DOESN'T Love You 🐱 | Cat Psychology
- **Slug:** `signs-cat-doesnt-love-you`
- **Category:** Cat Psychology / Behavior / Negative-Mirror
- **Series:** Cat Asks Why
- **Status:** script
- **Date created:** 2026-05-19
- **Publish date:** 21 мая 2026 (Чт slot)
- **vidIQ:** seed 67.55 / monthly 14,333 — **GREEN** ✅ (first GREEN in batch). Related exact-match "5 signs your cat doesn't love you" 66.67 / **26,837 monthly**. Competitor @williamcat negative-mirror format = 8.8M views proof.
...
TIME 0–1.5s: Frame opens with the woman's hand already reaching in from the right edge — fingers extended toward Brain. Brain captured at the inflection moment of the recoil — body mid-twist-away to the left, ears mid-slam-flat, tail mid-tuck. NO calm setup — the action is already in motion at frame 0.

TIME 1.5–3s: The recoil completes — Brain's body locks into the defensive crouch with ears fully pinned flat, tail fully tucked, wide cold dilated emerald eyes locked on the hand. The hand freezes mid-air a few inches from Brain (rejected, not reaching further). Brain holds the recoil pose frozen.

TIME 3–7s: Brain holds the frozen rejected pose. Camera continues aggressive push-in to amplify intensity. After a beat at TIME 4-5s Brain very slowly turns his head a fraction toward camera, wide cold emerald eyes meeting viewer with a knowing "yes, this is what NOT-loved looks like" expression. Tail-tip gives one tiny anxious flick. The hand stays frozen in rejected position throughout.

EYE COLOR RULE (strict): BRIGHT EMERALD GREEN (#3DDC84) — dilated wide. NOT brown, NOT amber.

ANATOMY RULE (strict — Veo must NOT morph Brain's anatomy): EXACTLY 4 paws (2 front + 2 back, NO 5th paw) AND EXACTLY 2 EARS (NO third ear, NO phantom ear, NO ear-shaped artifact). EAR SHAPE LOCK: ears are pinned FLAT backward but their SHAPE and SIZE stay identical to input image — small kitten triangle ears flattened, NEVER stretching into bat-ears, NEVER elongating. Body stays slender 8-week-old kitten proportions in the crouch — NEVER morphing chubby, NEVER expanding chest. Brain's identity IDENTICAL to input image — face, fur saturation, emerald eye color #3DDC84, glasses, brown collar, gold heart tag.

MOUTH RULE (strict): Mouth stays closed the entire 7 seconds. Lips can tighten with stress but NO teeth showing, NO hissing-open-mouth, NO chattering. The defensive read comes from EARS + TAIL + EYES, not from the mouth.

HUMAN RULE (strict): Only the woman's right hand + forearm enters frame from the right edge. NEVER her face, NEVER her head, NEVER her body. Hand is slim, soft, feminine, with cream V-neck sweater sleeve visible at the forearm. Skin tone soft warm. NEVER a male hand, NEVER masculine build, NEVER different person between scenes, NEVER different sleeve color.

DIRECTIONAL RULE: Brain's body is locked twisting AWAY from the right (where the hand enters). Veo must NOT re-orient him to face the hand — the rejection direction stays consistent. Hand stays on the right edge, Brain stays twisted left.

STILLNESS-FREEZE RULE: After TIME 3s Brain stays frozen in the recoil pose throughout. ONLY allowed motions: small head-turn toward camera at TIME 4-5s, one tiny tail-tip flick at TIME 6-7s. NO recovery, NO body shift, NO standing up. The frozen pose IS the message.

NEGATIVE SPACE RULE: Keep the upper-third of frame clean — "5 SIGNS YOUR CAT DOESN'T LOVE YOU" text plate slams in during editing.
...
TIME 0–1.5s: Brain locked in defensive crouch with ears slammed flat. The cartoon "1" numeral fades in to upper-left with a soft sparkle.

TIME 1.5–4s: Brain stays in the crouch — alert dilated eyes locked off-frame left, ears stay pinned flat throughout. After a beat his EAR FLATTENING DEEPENS — ears press even tighter against his head (clearly defensive amplification). Tail-tip flicks once tensely.

TIME 4–7s: Brain very slowly turns his head a fraction toward camera, wide dilated emerald eyes meeting viewer with a "see? this is what fear looks like" expression. Ears stay pinned flat throughout. Gold heart tag glints. Final beat holds the frozen flat-eared pose.

EYE COLOR RULE (strict): BRIGHT EMERALD GREEN (#3DDC84) wide and dilated. NOT brown, NOT amber.

ANATOMY RULE (strict): EXACTLY 4 paws AND EXACTLY 2 EARS. NO 5th paw, NO phantom 3rd ear, NO extra fur tuft. EAR SHAPE LOCK: ears are pinned FLAT but their SHAPE and SIZE stay identical to input image — small kitten triangle ears flattened backward, NEVER stretching into bat-ears, NEVER elongating, NEVER one-ear-pinned-other-perky. Both ears flat symmetric. Body stays slender kitten proportions. Brain's identity IDENTICAL to input.

MOUTH RULE (strict): Mouth stays closed the entire 7 seconds. No lip-sync, no hissing-open mouth.

NUMERAL RULE: The cartoon "1" stays in upper-left throughout, locked in pastel-yellow rounded sans-serif font per TYPOGRAPHY LOCK. Subtle sparkle particles around it pulse gently. NEVER drift to a different font mid-clip.
...
TIME 0–2s: Brain low-crouched on the rug with tail tucked tight under his belly. The "2" cartoon numeral fades in to upper-left with sparkle.

TIME 2–4.5s: Brain holds the anxious crouch — eyes shift slightly off-frame anxiously. The tail tucks even TIGHTER under him (slight visible cinching motion — the tail-tip presses closer to his belly). One small worried whisker twitch.

TIME 4.5–7s: Brain slowly turns his head a fraction toward camera, large anxious emerald eyes meeting viewer briefly. Ears stay partially flattened. Tail stays tucked tight throughout. Gold heart tag glints. Final beat holds the low-tucked pose.

EYE COLOR RULE (strict): BRIGHT EMERALD GREEN (#3DDC84). NOT brown, NOT amber.

ANATOMY RULE (strict): EXACTLY 4 paws AND EXACTLY 2 EARS. NO 5th paw, NO phantom 3rd ear. EAR SHAPE LOCK: ears partially flattened but shape and size identical to input — never stretching. Body stays slender kitten proportions. Brain's identity IDENTICAL to input.

MOUTH RULE (strict): Mouth stays closed the entire 7 seconds.

TAIL RULE (strict): The tail stays TUCKED TIGHT under Brain's body throughout — wrapped forward between his hind legs, tail-tip visible close to his belly. NEVER lifted, NEVER straight up, NEVER curled around his paws in the calm-pose way. The tucked-tail IS the visual message. Allowed motion: the tucked tail can CINCH slightly tighter once (TIME 3-4s).

NUMERAL RULE: The cartoon "2" stays in upper-left throughout, locked in pastel-yellow rounded sans-serif font per TYPOGRAPHY LOCK. NEVER drift to a different font.

STILLNESS RULE: Brain stays in the anxious low-crouch throughout. ONLY allowed motions: tail tightening at TIME 3-4s, one whisker twitch at TIME 4s, slow head-turn toward camera at TIME 5-7s.
...
TIME 0–2s: Brain sits facing camera with cold-fixed unblinking emerald stare. The "3" cartoon numeral fades in to upper-left with sparkle. The "❌ NO BLINK" pastel-red badge fades in to the right of his eyes.

TIME 2–5s: Brain holds the unblinking stare CONTINUOUSLY — eyes do NOT blink for 5 full seconds (clearly counter-natural for a cat, which is the visual point). Body completely still. Mouth flat-line. One tail-tip flick at TIME 3s — the tiny "I'm not even pretending" twitch. After a beat at TIME 4s, the "❌ NO BLINK" badge pulses softly red to reinforce.

TIME 5–7s: Brain continues the unblinking stare. After a beat his head tilts a fraction (NOT a blink, just a head tilt). The cold fixed-stare deepens slightly. Final frame holds the unblinking pose.

EYE COLOR RULE (strict): BRIGHT EMERALD GREEN (#3DDC84) wide open and FIXED. NOT brown, NOT amber.

NO-BLINK RULE (strict — central to the scene): Brain's eyes MUST stay OPEN AND UNBLINKING throughout the entire 7 seconds. NO blink at any frame. NO half-blink. NO eyelid movement. The fixed unblinking stare IS the visual proof — Veo must preserve this through every frame.

ANATOMY RULE (strict): EXACTLY 4 paws AND EXACTLY 2 EARS. NO 5th paw, NO phantom 3rd ear. Ear shape identical to input — small neutral kitten triangle ears. Body stays slender kitten proportions. Brain's identity IDENTICAL to input.

MOUTH RULE (strict): Mouth stays closed in a flat line — NOT a smirk, NOT a frown. Flat neutral closed mouth throughout.

STILLNESS RULE: Brain stays seated facing camera throughout. ONLY allowed motions: one tail-tip flick at TIME 3s, one tiny head-tilt at TIME 5-6s. NO body shift, NO blink, NO whisker twitch.

NUMERAL + BADGE RULE: Cartoon "3" stays in upper-left, "❌ NO BLINK" badge stays right of eyes — both in locked pastel-yellow rounded sans-serif font (the badge in pastel-red fill instead). NEVER drift to different fonts.
...
TIME 0–2s: Wide establishing — empty rug center frame, cream armchair right with the two glowing emerald eyes peeking from the dark gap under it. The "4" cartoon numeral fades in to upper-left with sparkle.

TIME 2–4.5s: Camera slowly pushes in toward the armchair. The two emerald eyes track the camera — they shift VERY slightly side-to-side as if Brain is watching the camera approach. Tiny ear silhouettes barely visible in shadow rotate forward slightly. NO body movement out from the shadow.

TIME 4.5–7s: Camera close to the armchair now. The eyes blink ONCE softly (this is a fear-blink, not a love-blink — quick, defensive, then re-open wider). The hiding pose holds firm — Brain does NOT come out, does NOT shift position. Final beat holds on the two eyes glowing from the shadow.

EYE COLOR RULE (strict): BRIGHT EMERALD GREEN (#3DDC84) GLOWING vividly from the shadow. NOT brown, NOT amber.

ANATOMY RULE (strict): Brain has EXACTLY 4 paws AND EXACTLY 2 EARS (the ears visible only as tiny silhouettes in the shadow). NO third ear. Body stays slender kitten proportions (silhouette only).

MOUTH RULE: Mouth not visible in framing.

HIDING RULE (strict): Brain stays HIDDEN under the armchair throughout — only his glowing eyes (and faint silhouette) visible. He does NOT come out, does NOT crawl forward, does NOT extend a paw. The hiding IS the message.

NUMERAL RULE: Cartoon "4" stays in upper-left, locked in pastel-yellow rounded sans-serif font. NEVER drift.

NEGATIVE SPACE RULE: The empty center rug should stay clean — the visual contrast (where Brain was vs where Brain hid) carries the beat.
...
TIME 0–1.5s: Frame opens MID-ACTION at the swat inflection — Brain's right front paw mid-air in swat motion, ears slammed flat, eyes wide on the woman's hand entering from the right. The "5" cartoon numeral fades in to upper-left with sparkle. NO calm setup.

TIME 1.5–3s: The swat completes — Brain's right paw extends fully toward the hand in a clean defensive swat. The woman's hand RECOILS BACK slightly (visibly pulling back from the contact). Brain's body stays coiled-back, ears still slammed flat. A small cartoon-style "💥 OUCH" pop-burst overlay (in locked typography pastel-yellow rounded sans bold, charcoal stroke) flashes briefly at the contact point.

TIME 3–5s: Brain retracts his swat-paw a fraction but stays in defensive coiled-back stance — ears still pinned flat, eyes still wide and locked on the hand. The hand continues to retreat off-frame right. The "OUCH" pop fades out.

TIME 5–7s: Brain holds the defensive coiled pose — body still tense, ears still flat, wide emerald eyes turn a fraction toward camera with a "yes, that just happened" cold expression. Tail-tip gives one tense flick. Final beat holds the post-swat tension pose.

EYE COLOR RULE (strict): BRIGHT EMERALD GREEN (#3DDC84) wide intense. NOT brown, NOT amber.

ANATOMY RULE (strict): EXACTLY 4 paws AND EXACTLY 2 EARS. NO 5th paw, NO phantom 3rd ear, NO extra fur tuft. The raised swatting paw counts as one of the 4 (the other 3 are: one planted front + two planted hind). NEVER add a 5th paw mid-motion. Ear shape and size identical to input — small kitten triangle ears flattened backward, NEVER stretching, NEVER becoming bat-shape. Body stays slender kitten proportions. Brain's identity IDENTICAL to input.

MOUTH RULE (strict): Mouth stays CLOSED throughout. Nose can wrinkle slightly with defensive tension, but NO open-mouth hiss, NO teeth showing, NO chattering. The hiss is implied by ear+eye+paw, NOT by mouth.

HUMAN RULE (strict): Only the woman's right hand + forearm visible from the right edge. NEVER her face, NEVER her body. Hand slim feminine, cream V-neck sweater sleeve at the forearm, soft warm skin tone. MUST match the locked human spec from Sc 1 (same hand, same sleeve, same skin tone). NEVER a male hand, NEVER different person.

DIRECTIONAL RULE: The swat motion goes RIGHTWARD toward the hand. Brain's body stays coiled facing right. Veo must NOT re-orient him left mid-clip.

CLAW RULE: Keep claws SOFT and Pixar-friendly. NO scary horror-claws, NO blood, NO sharp anatomical realism. The swat reads as defensive cat-warning, NOT graphic violence.

NUMERAL + OVERLAY RULE: Cartoon "5" stays in upper-left, "💥 OUCH" pop overlay flashes briefly at contact point at TIME 1.5-3s — both locked in pastel-yellow rounded sans-serif TYPOGRAPHY LOCK font. NEVER drift.
...
TIME 0–2s: Brain in relaxed loving seated pose, ears perked perfectly upright, tail wrapped softly. The "NONE = LOVED 💚" text fades in to upper-left.

TIME 2–4.5s: Brain gives one DELIBERATE SLOW BLINK at camera — eyes close softly for ~1s, hold closed for ~0.5s, open softly. The pastel-pink cartoon heart pops up above his head as his eyes re-open, with a soft sparkle burst. The heart gently floats upward and pulses softly twice.

TIME 4.5–7s: Brain holds the warm post-blink loving gaze at camera. Small content tail-tip flick. Soft head-tilt with affectionate expression. Final beat holds the warm composed pose with the heart still glowing above. Gold heart tag glints. Sparkle particles around Brain twinkle softly.

EYE COLOR RULE (strict): BRIGHT EMERALD GREEN (#3DDC84) warm. NOT brown, NOT amber.

ANATOMY RULE (strict): EXACTLY 4 paws AND EXACTLY 2 EARS. NO 5th paw, NO phantom 3rd ear. EAR SHAPE LOCK: ears PERFECTLY UPRIGHT in friendly perked position — clearly distinct from the flat-pinned ears of prior scenes. Shape and size identical to input. Body stays slender kitten proportions. Brain's identity IDENTICAL to input.

MOUTH RULE (strict): Mouth stays closed in a warm soft smirk throughout. No lip-sync.

POSE-CONTRAST RULE: This scene's relaxed loving pose MUST visually contrast with the defensive poses of Sc 1-6. Ears UP not flat, tail wrapped softly not tucked, eyes warm half-lidded not wide-cold. The contrast is the emotional cathartic point.

HEART RULE: The pastel-pink cartoon heart is a clearly stylized 2D cartoon overlay floating above Brain's head — NOT realistic, NOT photorealistic. Soft pink fill with white sparkle. Pops up at TIME 2.5s synced to the slow-blink. Floats and pulses gently twice.
...
The 5 Signs Your Cat Doesn't Actually Love You 🐱 | Cat Psychology
...
Ваша Кошка ВАС НЕ ЛЮБИТ? 5 Признаков (Проверьте Сейчас)
...
🐱 Follow Brain for daily cat psychology, cat facts, and cat behavior secrets.
...
THUMBNAIL FRAMING: Brain face fills ~60% of frame, slight 2-4° tilt, glaring INTENSELY at viewer with wide cold dilated emerald eyes, ears slammed flat backward, mouth closed in tense flat line, nose slightly wrinkled with defensive tension. His right front paw is RAISED MID-SWAT toward the right edge of frame. Reaching in from the right: a slim feminine woman's hand recoiling back (cream V-neck sweater sleeve visible, no face, only the hand + forearm) — clearly being rejected. Background soft warm honey-amber bokeh of the cozy living room (sage-green rug + cream armchair faintly visible but heavily blurred). A small soft red ❌ icon hovers near the rejected hand.
...
EYE COLOR RULE (strict): BRIGHT EMERALD GREEN (#3DDC84) DILATED WIDE COLD. NOT brown, NOT amber.
