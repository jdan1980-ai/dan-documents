...
- **Status:** ready for production · all 66 image prompts fully glued (copy-paste ready)
...
## 🔒 Locked Style Block (already baked into every image prompt below — verbatim, never alter)
...
> Each image prompt below is fully self-contained (style block baked in) — copy straight into Nano Banana. Scenes marked 🎬 also get a Veo animation (~4 s, image-to-video). Per-shot screen time is set in the editor under each VO line.
...
**🎨 Image prompt:**
```
A tiny doodle proto-mammal (round white head, big round eyes with dot pupils, thin stick body, tiny rounded ears, short tail, bold black marker outline) crouching low between two enormous dinosaur legs in a dark prehistoric forest at dusk, the giant legs towering above, the small creature looking up afraid. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
...
**🎨 Image prompt:**
```
A tiny doodle proto-mammal (round white head, big round eyes with dot pupils, thin stick body, tiny rounded ears, short tail, bold black marker outline) peeking out from a hollow log, only its head and big reflective eyes visible, a small flat-yellow moon above. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Extreme close-up of two big round black-outlined doodle eyes with small dot pupils glowing in pure darkness, nothing else visible, mysterious, plain background. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle outline of a small proto-mammal slowly morphing into the silhouette of a modern cat, shown as a faint grey ghost overlay over the black outline, transformation arrows around it. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle flaming asteroid (round rock with a simple orange-yellow flame streak, bold black outline) streaking across a flat dark-blue night sky above a simple black-outline forest, orange glow rising on the horizon. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A huge doodle fireball impact on a flat horizon line, a simple expanding orange-and-black shockwave ring spreading outward across an empty white plain. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Two doodle dinosaur skeletons lying half-buried in flat grey ash on an empty white ground, simple bold outlines, silent and still. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A split doodle frame divided by a thin black line: on the left a huge fallen doodle dinosaur lying down, on the right a tiny living doodle proto-mammal (round white head, big round eyes with dot pupils, thin stick body, tiny rounded ears, short tail, bold black marker outline) standing alive, contrast of big versus small. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
The tiny doodle proto-mammal (round white head, big round eyes with dot pupils, thin stick body, tiny rounded ears, short tail, bold black marker outline) stepping out onto cracked flat-grey ash ground, a faint flat-yellow sunbeam breaking through above it. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A wide empty doodle valley drawn in simple black outline, the lone tiny doodle proto-mammal small at the very center, lots of empty white space around it suggesting a whole world to itself. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A doodle tree-of-life diagram with one trunk branching into many small mammal silhouettes sprouting in all directions, simple black branch lines on white. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
The same doodle tree-of-life diagram but only one branch is highlighted bold black while all other branches are faded light grey, a single doodle wildcat silhouette at the tip of the bright branch. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) creeping along a flat-green mossy branch in a simple ancient forest, hand-lettered uppercase text "PROAILURUS" above it. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
Four simple doodle icon close-ups arranged in a row on white: a big round eye, a padded paw, a retracting claw, and a pointed triangular ear, each circled in bold black marker outline. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A single doodle wildcat silhouette in the center fanning outward into many different doodle cat silhouettes radiating in all directions like a family fan, simple black outlines on white. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A flat sky-blue divider card with a single doodle cat eye opening in the very center, big round black-outlined eye with a dot pupil, minimal. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle fork diagram with one path splitting into two, the upper path labeled in hand-lettered uppercase text "BIG CATS" and the lower path labeled "SMALL CATS", simple black arrows on white. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Three doodle big cats — a lion, a tiger, a leopard — striding in a row across a flat golden-yellow savanna strip, each with a round white head, big round eyes, pointed ears and flat-colored bodies, bold black marker outline. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A doodle sabertooth cat (round white head, big round eyes, two long curved white fangs, flat tan body, bold black marker outline) snarling, fangs bared, on a flat sky-blue icy background. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle sabertooth cat (round white head, big round eyes, two long curved white fangs, flat tan body, bold black marker outline) frozen mid-roar slowly fading into a faint light-grey outline on plain white, ghostly. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle sabertooth skeleton lying in cracked dry flat-tan earth, and a small living doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) walking calmly past it. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) watching from tall flat-green grass, only its head and ears visible above the grass, alert. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) in a low stalking pose, body stretched flat, focused stare, on plain white. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Extreme close-up of one big round doodle cat eye with a dot pupil, the pupil widening, a faint grey glow ring drawn behind the eye, on plain white. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Two pointed doodle cat ears at the top, rotating, with thin black sound-wave rings rising from flat-grey ground below them. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) frozen mid-pounce in an arc toward unseen prey, small black dust marks kicking up below. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) standing proud on a small flat-grey rock at dawn, a wide empty flat landscape behind, a small flat-yellow sun low. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) shown in side profile, hand-lettered uppercase text "FELIS SILVESTRIS LYBICA" below it. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) alone on cracked flat-tan desert ground, tense, ears low, scanning, lots of empty white space around. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle human handprint on a flat-grey cave wall fading in over a faint desert scene, warm flat-orange torch light glow at the edge. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A small doodle mud-brick village at the edge of a desert, simple flat-tan huts, thin black smoke rising from one, plain pale background. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
Two simple doodle stick-figure humans (round white head, big round eyes, thin line body, bold black marker outline) harvesting golden flat-yellow wheat by hand, a simple flat-tan hut behind them. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Several doodle clay storage jars (each overflowing with small yellow grain dots, bold black outline) lined up inside a simple flat-grey stone room. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Many small doodle mice swarming over and around a doodle clay storage jar (overflowing with small yellow grain dots, bold black outline) in a dim flat-grey room. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat's eyes (big round black-outlined eyes with dot pupils) appearing in the dark doorway of a flat-grey granary, body in shadow, watching small doodle mice near the grain. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) stepping over a flat-grey stone threshold on its own, cautious, tail held low. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) sitting calmly among doodle clay grain jars, a small caught doodle mouse at its feet. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) slowly relaxing beside a sleeping doodle stick-figure human, hand-lettered uppercase text "SELF-DOMESTICATION" above. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A divider card: a doodle house cat face (round white head, big round eyes, pointed ears) slowly dissolving into a doodle wildcat face, half and half, on flat sky-blue. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Two doodle stick-figure humans (round white head, big round eyes, thin line body, bold black marker outline) as archaeologists brushing soil off a flat-grey burial pit, a small flat-yellow lantern glow, small hand-lettered text "2004". flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
Two simple doodle skeletons lying side by side in flat-tan earth, one a human stick-figure skeleton and one a small cat skeleton, arranged gently together. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
The doodle human-and-cat dual burial in flat-tan earth with hand-lettered uppercase text "9,500 YEARS" above, a soft flat-yellow glow around them. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A glowing doodle DNA double helix in black outline over a simple flat world map, small hand-lettered text "2007", thin black tracing lines spreading out. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Countless small doodle cat silhouettes spread across a simple flat world map, all connected by thin black lines back to a single doodle wildcat in the Near East region. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A doodle house cat (round white head, big round eyes with dot pupils, pointed ears, simple flat-grey body, curled tail, bold black marker outline) sitting on the deck of a simple doodle wooden sailing ship on a flat sky-blue sea, a triangular sail above. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle seated cat statue colored flat yellow-gold (big round eyes, bold black outline) glowing inside a simple flat-grey temple with flat-orange torch light. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Simple doodle Egyptian wall carvings showing flat yellow-gold cats placed high and honored above small kneeling doodle stick-figure humans, on a flat-tan wall. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle seated yellow-gold Egyptian cat statue whose big round eyes flicker into living doodle wildcat eyes, half statue half alive, flat-orange glow. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A glowing doodle cat outline gently splitting into two halves, the left half labeled hand-lettered "WILD" and the right half labeled "TAME", on plain white. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A row of doodle dogs morphing left to right from a grey wolf into a tiny flat-brown lapdog, four simple stages in a line on plain white. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle wildcat (round white head, big round black-outlined eyes with dot pupils, pointed triangular ears, thin striped body in flat grey, long thin tail, bold black marker outline) and a doodle house cat side by side, nearly identical, a faint black "=" sign between them. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle house cat (round white head, big round eyes with dot pupils, pointed ears, simple flat-grey body, curled tail, bold black marker outline) sitting on a windowsill with a faint light-grey wildcat silhouette glowing inside its body. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle house cat (round white head, big round eyes with dot pupils, pointed ears, simple flat-grey body, curled tail, bold black marker outline) by a door, half of its silhouette stepping out into wild flat-green grass and half staying inside on plain white. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
Close-up of a content doodle house cat (round white head, big round eyes half-closed, pointed ears, flat-grey body) near a doodle stick-figure human hand reaching gently toward it. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A doodle house cat (round white head, big round eyes with dot pupils, pointed ears, simple flat-grey body, curled tail, bold black marker outline) looking up at a doodle stick-figure human, a small speech bubble with hand-lettered text "MEOW". flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Two doodle cats ignoring each other in silence on the left, and on the right one doodle house cat (round white head, big round eyes with dot pupils, pointed ears, simple flat-grey body, curled tail, bold black marker outline) meowing up at a doodle stick-figure human, a small "MEOW" bubble. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Close-up of a purring doodle house cat (round white head, big round eyes closed, pointed ears, flat-grey body) curled against a doodle stick-figure human chest, soft black vibration rings radiating outward. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎬 Animation prompt (Veo):**
```
...
**🎨 Image prompt:**
```
A long glowing doodle timeline drawn left to right on plain white: from a small flaming asteroid, through a wildcat, to a modern house cat, ending at a doodle stick-figure human silhouette, thin black line connecting them. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
A dim modern doodle living room scene in flat sky-blue, a plain ordinary doodle ginger house cat (round white head with flat ginger-orange fill and a few darker orange tabby stripes, white muzzle and chest, NO glasses, NO collar, big round eyes CLOSED asleep, pointed orange ears, curled tail, bold black marker outline, mouth closed) curled asleep on a simple couch, a warm flat-yellow lamp glow. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
**🎨 Image prompt:**
```
Closer view of the same plain ordinary doodle ginger house cat (flat ginger-orange fill, darker orange tabby stripes, white muzzle and chest, NO glasses, NO collar, big round eyes CLOSED asleep, pointed orange ears, curled tail, bold black marker outline, mouth closed) sleeping on the couch, the rest of the flat sky-blue room darkening around it, lamp glow on the cat. flat 2D hand-drawn doodle explainer illustration, bold slightly uneven black marker ink outlines of even weight, naive whiteboard-cartoon style, simple stick-figure characters with large round white heads, big round black-outlined eyes with eyelids and small dot pupils, thin line bodies and stick limbs, flat solid color fills with no gradients or shading, mostly plain white background with occasional single flat color scene, restricted palette of black, white, grass-green, grey, sky-blue, orange and yellow, hand-lettered uppercase marker text, lots of empty negative space, clean and minimal. 16:9 horizontal composition, centered subject, plenty of white negative space
```
**🎙️ Voiceover:**
```
...
1. Generate all 66 doodle images in Nano Banana (16:9). Each prompt above is self-contained — paste as-is.
...
Your Cat Survived the Asteroid That Killed the Dinosaurs 🐱
```
...
00:00 The thing under the dinosaurs
00:30 The asteroid
01:00 The first cats
01:45 The sabertooth dead end
02:20 The perfect small predator
03:00 Who tamed whom
03:50 The evidence
04:20 The cat inside your cat
...
Extended set (description body):

```
#catevolution #cathistory #catfacts #catpsychology #braincatai #catdomestication #animalfacts
```
