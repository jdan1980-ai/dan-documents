#!/usr/bin/env python3
"""BENZAITEN thumbnail — 弁財天 WHITE calligraphic (white reads clean against
this hero's cool teal spirit, same lesson as AMATERASU/HACHIMAN), VERTICAL
stack in the left corner, matching the KAMI series treatment (cloned from
the FIXED tsukuyomi-compose-thumb.py, so the corrected gold_kanji_v bounds
formula is used from the start). BENZAITEN large white serif low-centre on
the dark foreground platform wood.
"""
from PIL import Image, ImageDraw, ImageFont, ImageFilter, ImageEnhance, ImageChops

SRC = "/home/user/dan-documents/stillwave/assets/benzaiten-1h-source.jpg"
KANJI = "/home/user/dan-documents/stillwave/assets/fonts/YujiSyuku-Regular.ttf"
SERIF = "/usr/share/fonts/truetype/dejavu/DejaVuSerif-Bold.ttf"
OUT = "/home/user/dan-documents/stillwave/assets/benzaiten-1h-thumb.jpg"
W, H = 1920, 1080
...
im = base()
CENTRE = 960
# 弁財天 — VERTICAL calligraphic white, left corner (sky/mountain area, clear
# of the goddess who sits further right in this composition)
white_kanji_v(im, ["弁", "財", "天"], 220, 150, 130, pitch=260, halo=32)
# BENZAITEN — large white serif, low-centre on the dark foreground platform wood
spaced_centre(im, "BENZAITEN", 120, CENTRE, 900, fill=WHITE, ls=16, font=SERIF)
