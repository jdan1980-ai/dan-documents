#!/usr/bin/env python3
"""TSUKUYOMI thumbnail — 月読 gold calligraphic (dark starlit night sky reads
gold cleanly, same case as SUIRYU/KARYU/SEIRYU), VERTICAL stack in the left
corner, matching the KAMI/RYU series treatment. Font = Yuji Syuku — verified
both 月 and 読 render as complete glyphs at this size (no clipping). TSUKUYOMI
large gold serif low-centre on the dark foreground rock.
"""
...
OUT = "/home/user/dan-documents/stillwave/assets/tsukuyomi-2h-thumb.jpg"
W, H = 1920, 1080
...
im = base()
CENTRE = 960
# 月読 — VERTICAL calligraphic gold, left corner, in the dark starlit sky band
gold_kanji_v(im, ["月", "読"], 240, 150, 140, pitch=288, halo=32)
# TSUKUYOMI — large gold serif, low-centre on the dark foreground rock
spaced_centre(im, "TSUKUYOMI", 130, CENTRE, 890, fill=GOLD, ls=18, font=SERIF)
