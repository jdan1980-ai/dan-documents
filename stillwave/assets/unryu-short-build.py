#!/usr/bin/env python3
"""UNRYU Short builder — 6 vertical shots, jitter-free Ken Burns (PIL float crop).

fr1 samurai + full dragon on the summit (hook) · fr2 cloud sea macro, sunbeams (breather)
fr3 dragon head close, glowing eyes (reveal) · fr4 open sky + single distant peak (concept 雲龍 + UNRYU)
fr5 stone lantern + gate detail (scene) · fr6 wide samurai + dragon (wisdom / close)
"""
...
SHOTS = [
    ("unryu-shorts-fr1.jpg", True),
    ("unryu-shorts-fr2.jpg", False),
    ("unryu-shorts-fr3.jpg", True),
    ("unryu-shorts-fr4.jpg", False),
    ("unryu-shorts-fr5.jpg", True),
    ("unryu-shorts-fr6.jpg", False),
]
ZOOM = 0.10

# step = 5.7, total = 5.7*5 + 6.5 = 35.0s
OVERLAYS = [
    ("unryv_hook.png", 3.0, 8.4),        # shot 1
    ("unryv_concept.png", 18.0, 23.0),  # shot 4 (starts 17.1)
    ("unryv_wisdom.png", 29.6, 34.0),   # shot 6 (starts 28.5)
]
FADE = 0.9
END_FADE = 1.0
