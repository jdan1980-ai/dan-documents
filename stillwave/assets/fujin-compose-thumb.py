#!/usr/bin/env python3
"""FUJIN thumbnail — 風神 WHITE calligraphic (white reads clean against
this hero's storm-grey/jade spirit, same lesson as AMATERASU/HACHIMAN/
BENZAITEN/KANNON), VERTICAL stack in the upper-left corner (the stormy
sky there is calm and clear of both the monk and the spirit). FUJIN
large white serif low-centre on the foreground grass/rock, clear of the
hawk on the right.
"""
from PIL import Image, ImageDraw, ImageFont, ImageFilter, ImageEnhance, ImageChops

SRC = "/home/user/dan-documents/stillwave/assets/fujin-1h-source.jpg"
KANJI = "/home/user/dan-documents/stillwave/assets/fonts/YujiSyuku-Regular.ttf"
SERIF = "/usr/share/fonts/truetype/dejavu/DejaVuSerif-Bold.ttf"
OUT = "/home/user/dan-documents/stillwave/assets/fujin-1h-thumb.jpg"
W, H = 1920, 1080
...
im = base()
CENTRE = 940
# 風神 — VERTICAL calligraphic white, upper-left corner (stormy sky, clear of
# the monk who stands centre-frame and the spirit who fills the right side)
white_kanji_v(im, ["風", "神"], 240, 150, 130, pitch=288, halo=32)
# FUJIN — large white serif, low-centre on the foreground grass/rock, clear of the hawk
spaced_centre(im, "FUJIN", 130, CENTRE, 900, fill=WHITE, ls=18, font=SERIF)
