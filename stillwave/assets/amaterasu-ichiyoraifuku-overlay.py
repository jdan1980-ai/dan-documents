#!/usr/bin/env python3
"""AMATERASU wisdom overlay — 1920x1080 transparent PNG for the long-form intro.

一陽来復 / Ichiyō raifuku / "Light returns after darkness" — a classical idiom
for the turning point when light and warmth return after the darkest
stretch, directly mirroring the Ama-no-Iwato myth. Overlay ≠ title concept
(series rule, same logic as the RYU/HACHIMAN/TSUKUYOMI scripts).

LEFT-lower over the dark(er) foreground cliff rock, clear of the shrine/
torii and the monk. In CapCut: TEXT layer on the top track, start 0:03, end
...
this uses the SAME-Y horizontal layout as tsukuyomi-wisdom-overlay.py
(no per-character y-offset, so no risk of the vertical-stack clipping bug)."""
from PIL import Image, ImageDraw, ImageFont, ImageFilter

SRC = "/home/user/dan-documents/stillwave/assets/amaterasu-2h-source.jpg"
KANJI = "/home/user/dan-documents/stillwave/assets/fonts/YujiBoku-Regular.ttf"
SERIF = "/usr/share/fonts/truetype/liberation/LiberationSerif-Bold.ttf"
OUT = "/home/user/dan-documents/stillwave/assets/amaterasu-ichiyoraifuku-overlay.png"
...
# soft scrim so cream reads over the warm-lit cliff rock in the lower-left
...
d.text((X + 4, 866), "Ichiyo raifuku", font=ImageFont.truetype(SERIF, 54), fill=CREAM)
d.text((X + 4, 940), "Light returns after darkness",
...
prev.save(f"{SP}/amaterasu-overlay-preview.jpg", quality=92)
print("preview saved")
