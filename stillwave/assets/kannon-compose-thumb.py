#!/usr/bin/env python3
"""KANNON thumbnail — 観音 WHITE calligraphic (white reads clean against
this hero's soft rose-pink spirit, same lesson as AMATERASU/HACHIMAN/
BENZAITEN), VERTICAL stack in the left corner, matching the KAMI series
treatment (cloned from the FIXED tsukuyomi-compose-thumb.py, so the
corrected gold_kanji_v bounds formula is used from the start). KANNON
large white serif low-centre on the dark foreground temple steps.
"""
from PIL import Image, ImageDraw, ImageFont, ImageFilter, ImageEnhance, ImageChops

SRC = "/home/user/dan-documents/stillwave/assets/kannon-1h-source.jpg"
KANJI = "/home/user/dan-documents/stillwave/assets/fonts/YujiSyuku-Regular.ttf"
SERIF = "/usr/share/fonts/truetype/dejavu/DejaVuSerif-Bold.ttf"
OUT = "/home/user/dan-documents/stillwave/assets/kannon-1h-thumb.jpg"
W, H = 1920, 1080
...
im = base()
CENTRE = 960
# 観音 — VERTICAL calligraphic white, left corner (forest/sky area, clear of
# the goddess who stands further right/centre in this composition)
white_kanji_v(im, ["観", "音"], 240, 150, 140, pitch=288, halo=32)
# KANNON — large white serif, low-centre on the dark foreground temple steps
spaced_centre(im, "KANNON", 130, CENTRE, 890, fill=WHITE, ls=18, font=SERIF)
