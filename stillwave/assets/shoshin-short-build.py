#!/usr/bin/env python3
"""SHOSHIN Short builder — 6 vertical shots, jitter-free Ken Burns (PIL float crop).

Shots (user-generated 9:16 stills):
  fr1 monk before the round autumn window (hook) · fr2 crimson maple (macro)
  fr3 round window + autumn garden · fr4 tokonoma maple branch (concept 初心)
  fr5 fallen leaves on moss · fr6 soft-focus autumn bokeh (wisdom)
"""
...
SHOTS = [
    ("shoshin-shorts-fr1.jpg", True),
    ("shoshin-shorts-fr2.jpg", False),
    ("shoshin-shorts-fr3.jpg", True),
    ("shoshin-shorts-fr4.jpg", False),
    ("shoshin-shorts-fr5.jpg", True),
    ("shoshin-shorts-fr6.jpg", False),
]
ZOOM = 0.10

# step = 5.7, total = 5.7*5 + 6.5 = 35.0s
OVERLAYS = [
    ("shov_hook.png", 3.0, 8.4),        # shot 1
    ("shov_concept.png", 18.0, 23.0),   # shot 4 (starts 17.1)
    ("shov_wisdom.png", 29.6, 34.0),    # shot 6 (starts 28.5)
]
FADE = 0.9
END_FADE = 1.0
