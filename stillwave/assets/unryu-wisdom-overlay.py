#!/usr/bin/env python3
"""UNRYU wisdom overlay — 1920x1080 transparent PNG for the long-form intro.

雲外蒼天 / Ungai sōten / Beyond the clouds, a blue sky — a companion idiom to
...
OUT = "/home/user/dan-documents/stillwave/assets/unryu-ungaisoten-overlay.png"
...
prev.save(f"{SP}/unryu-overlay-preview.jpg", quality=92)
print("preview saved")
