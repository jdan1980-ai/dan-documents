#!/usr/bin/env python3
"""WA Short builder — 6 vertical shots, jitter-free Ken Burns (PIL float crop).

fr1 monk at the mirror pond (hook) · fr2 concentric ripple (macro breather)
fr3 stone lantern + maple (scene) · fr4 misty open sky (concept 和 + WA)
fr5 two koi (harmony) · fr6 floating maple leaves (wisdom)
"""
...
SHOTS = [
    ("wa-shorts-fr1.jpg", True),
    ("wa-shorts-fr2.jpg", False),
    ("wa-shorts-fr3.jpg", True),
    ("wa-shorts-fr4.jpg", False),
    ("wa-shorts-fr5.jpg", True),
    ("wa-shorts-fr6.jpg", False),
]
ZOOM = 0.10

# step = 5.7, total = 5.7*5 + 6.5 = 35.0s
OVERLAYS = [
    ("wav_hook.png", 3.0, 8.4),        # shot 1
    ("wav_concept.png", 18.0, 23.0),   # shot 4 (starts 17.1)
    ("wav_wisdom.png", 29.6, 34.0),    # shot 6 (starts 28.5)
]
FADE = 0.9
END_FADE = 1.0
