#!/usr/bin/env python3
"""SEIRYU Short builder — 6 vertical shots, jitter-free Ken Burns (PIL float crop).

fr1 samurai + starlit sky-dragon (hook) · fr2 dew on moss macro (breather)
fr3 sky-dragon head close, glowing eyes (reveal) · fr4 calm horizon at first
light (concept 青龍 + SEIRYU overlay — the "kanji frame") · fr5 stone lantern
detail (scene) · fr6 wide samurai + sunrise dragon, warmer light (wisdom / close)
"""
...
SHOTS = [
    ("seiryu-shorts-fr1.jpg", True),
    ("seiryu-shorts-fr2.jpg", False),
    ("seiryu-shorts-fr3.jpg", True),
    ("seiryu-shorts-fr4.jpg", False),
    ("seiryu-shorts-fr5.jpg", True),
    ("seiryu-shorts-fr6.jpg", False),
]
ZOOM = 0.10

# step = 5.7, total = 5.7*5 + 6.5 = 35.0s
OVERLAYS = [
    ("seiryv_hook.png", 3.0, 8.4),        # shot 1
    ("seiryv_concept.png", 18.0, 23.0),  # shot 4 (starts 17.1)
    ("seiryv_wisdom.png", 29.6, 34.0),   # shot 6 (starts 28.5)
]
FADE = 0.9
END_FADE = 1.0
