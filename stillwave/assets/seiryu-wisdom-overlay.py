#!/usr/bin/env python3
"""SEIRYU wisdom overlay — 1920x1080 transparent PNG for the long-form intro.

一陽来復 / Ichiyō raifuku / "One yang returns" — the classical image of the
turning point after the longest dark, when light and renewal begin to return.
Overlay ≠ title concept (series rule, same logic as WA/ICHIGO/SUIRYU/UNRYU/KARYU).

LEFT-lower over the dark foreground terrace stone. In CapCut: TEXT layer on
the top track, start 0:03, end 0:14, fade-in 2s / fade-out 2s, no glow/shadow/box.
Cream #F5EAD2, Liberation Serif Bold (the locked channel font). 4 kanji.
Raw-glyph check: all 4 chars (incl. the sparse single-stroke 一) render as
complete Yuji Boku brush glyphs at this size — no repeat of the KARYU 火
flat-cut-tip issue."""
...
OUT = "/home/user/dan-documents/stillwave/assets/seiryu-ichiyoraifuku-overlay.png"
...
# soft scrim so cream reads over the dark foreground terrace stone in the lower-left
...
d.text((X + 4, 940), "One yang returns",
...
prev.save(f"{SP}/seiryu-overlay-preview.jpg", quality=92)
print("preview saved")
