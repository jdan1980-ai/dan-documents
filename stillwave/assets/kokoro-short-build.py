#!/usr/bin/env python3
"""KOKORO Short builder — 6 vertical shots, jitter-free Ken Burns (PIL float crop).

Shots (user-generated 9:16 stills):
  fr1 monk before the golden Buddha (hook) · fr2 candle + incense (detail)
  fr3 Buddha face (mural) · fr4 dark upper temple hall (concept 心)
  fr5 hands + lotus (dhyana mudra) · fr6 monk before the golden thangka (wisdom)
...
SHOTS = [
    ("kokoro-shorts-fr1.jpg", True),
    ("kokoro-shorts-fr2.jpg", False),
    ("kokoro-shorts-fr3.jpg", True),
    ("kokoro-shorts-fr4.jpg", False),
    ("kokoro-shorts-fr5.jpg", True),
    ("kokoro-shorts-fr6.jpg", False),
]
ZOOM = 0.10

# step = 5.7, total = 5.7*5 + 6.5 = 35.0s
OVERLAYS = [
    ("kokov_hook.png", 3.0, 8.4),        # shot 1
    ("kokov_concept.png", 18.0, 23.0),   # shot 4 (starts 17.1)
    ("kokov_wisdom.png", 29.6, 34.0),    # shot 6 (starts 28.5)
]
FADE = 0.9
END_FADE = 1.0
