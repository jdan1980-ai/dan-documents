...
- **Status:** 🟡 IN PROGRESS — ✅ 38 Lyria tracks generated, mastered, selected (21 tracks, 59:34) → `HACHIMAN-ALBUM/`; ✅ hero image approved after 6 prompt-fix rounds (see §3 revision notes). **Next: generate the §4 Flow/Kling loop, generate §3c Shorts frames, then CapCut laydown.**
...
- **HACHIMAN (八幡) — visual hook:** a lone samurai kneels or stands in front of an actual Hachiman-zukuri shrine building at dusk (vermillion-lacquered wood, dark cypress-bark roof, curved chidori-hafu gable — the real architectural style of Usa Jingū, the origin shrine of all Hachiman worship, per the reference photo), facing a colossal warrior-spirit that takes shape out of the fading light itself above the shrine's roofline — armored in ghostly light-formed plate, holding a bow of warm honey-gold light calmly lowered at its side (never drawn or raised — this is a vigil, not a combat pose), its face calm and resolute. Two or three white doves (Hachiman's sacred messengers) perch calmly on the shrine roofline nearby, their forms faintly luminous — real birds at rest, never suspended in mid-air. The spirit's visible head, torso and bow are "made of" the light, the rest of its lower body dissolving into the darkening sky.
...
**Direction:** a lone samurai stands or kneels before a real Hachiman-zukuri shrine building (vermillion lacquered wood, dark cypress-bark roof, curved gabled porch — modeled on Usa Jingū) at dusk; above and behind him, a colossal warrior-spirit of honey-gold light takes shape above the shrine roofline, bow calmly lowered, doves perched on the roof — never a statue or mural.

```
Photorealistic cinematic still, 16:9, 4K, restrained and painterly, fully photoreal in every detail — NOT a video-game key-art poster, NOT a hyper-saturated fantasy illustration, NOT stylized, NOT cartoonish, NOT an animated or illustrated look of any kind, muted and cinematic like an actual film still shot on location, indistinguishable from a real photograph except for the glowing spirit itself. A lone samurai in dark weathered armor stands from behind, straight, smooth, dark black East Asian hair gathered into a simple low topknot (chonmage-style) — the hair itself is straight and sleek, NOT curly, NOT an afro texture, NOT braided, NOT dreadlocks, NOT coily or kinky — just smooth straight dark hair pulled back, with NO bald spot, NO balding, NO receding hairline, NO visible bare scalp anywhere, no helmet, back to the camera, centered in the lower third of a stone courtyard before an ancient Hachiman-zukuri shrine building at dusk — vermillion/orange-red lacquered wood pillars, beams and lattice railings, a dark thick cypress-bark roof, an ornate curved gabled entrance porch (chidori hafu) jutting forward from the main roofline, dark wood latticework windows, wide worn stone steps leading up to the veranda, modeled on the real architecture of Usa Jingū. A row of traditional paper lanterns (chōchin), warmly lit from within with a soft amber glow, hangs beneath the curved gabled porch eaves and along the veranda pillars, giving the shrine a sense of life and quiet ceremony rather than an abandoned ruin. A gentle warm light glows from somewhere within the shrine's interior, visible through the dark wood latticework windows, as if lit for evening rites. A thick shimenawa sacred straw rope, hung with white paper shide streamers, stretches across the top of the main entrance beneath the porch. Both of his arms hang straight down at his sides in a relaxed at-ease stance, like a soldier standing calmly — each hand's fingers reach only to about mid-thigh height, a clear gap of open air below his belt line and beside his hip where nothing is held. His two sheathed swords stay up at his hip, well above where his hanging hands reach — his hands and his swords occupy two clearly separate zones of his body that never touch or overlap. He looks up calmly toward a colossal warrior-spirit taking shape directly out of the fading dusk light above the shrine's roofline. The spirit's armored torso and face are DENSE and VOLUMETRIC, filled throughout with softly drifting light and mist in a rich, warm HONEY-GOLD and AMBER hue — like sunlight glowing through thin golden mist — explicitly NOT plain white, NOT pale grey-white, NOT the color of marble, porcelain, plaster, or carved stone; every part of it must carry a visible warm golden-amber tint, never a neutral or cool white. Its surface is fully opaque in silhouette — NOT a thin glowing outline, NOT a wireframe or line-art sketch, NOT a transparent contour you can see through — but the internal light is uneven and alive: brighter glowing patches drift and shift gently across the armor and face, softer dimmer areas elsewhere, like embers glowing unevenly inside a cloud — NOT a flat, uniform, evenly-lit surface like a statue or sculpture. Its face shows soft but recognizable features — brow, eyes, jaw — gently lit from within, not a smooth blank featureless dome. Critically, the SILHOUETTE of its head is NOT a smooth round sphere or bald dome shape at all — the outline of its head clearly includes a distinct topknot bump rising from the crown, the exact same simple chonmage knot-shape as the samurai standing below it, made of the same glowing golden light as the rest of its body. This hair-knot bump in the outline is mandatory and must be visible in every generation — a perfectly smooth, round, bald-looking head is a failed generation and must be avoided. The spirit's hair itself is straight and smooth — NOT curly, NOT an afro texture, NOT braided. The spirit holds a bow sized naturally in proportion to its own body — roughly as long as its torso — resting calmly lowered at its side, UNSTRUNG or held loosely with the string slack, NOT drawn back, NOT nocked with an arrow, NOT in an active aiming or shooting stance, NOT stretched into a wide glowing arc or light-trail spanning the frame. The whole composition is calm and contemplative, not a battle or combat scene — no tension in the pose, no sense of imminent action, a quiet vigil rather than a nocked shot. Its expression is calm and resolute — never a carved statue, never a painted mural, a living presence of dense light. The rest of the spirit's lower body trails off and dissolves into the darkening sky. Two or three real white doves perch calmly and naturally on the shrine's roofline near the spirit, standing still in an ordinary resting pose exactly as real birds do when perched — NOT hovering, NOT floating, NOT suspended in mid-air, NOT frozen mid-flight with wings spread; if they are not physically standing on a solid surface (the roof tiles, a beam, the porch railing) with their feet visibly resting on it, the pose is wrong. The samurai wears dark tabi socks and traditional straw waraji sandals bound with cord at the ankle — never barefoot. EXACTLY TWO swords — a katana and a shorter wakizashi (the daishō pair) — both fully sheathed at his LEFT hip only, thrust through the obi with the blade edge upward, both hilts angled forward and up — visible at his hip but NOT reached for, NOT gripped, NOT approached by either hand. NO third sword. Warm amber-and-gold dusk palette across the ENTIRE sky, fading into deep blue only at the very top edge of frame — the horizon and mid-sky must stay warm amber/gold, never a cool blue-dominant sky. The vermillion shrine walls glow warm in the last light, profound resolute stillness. Keep the lower-left corner dark and low-detail for a text overlay, keep the bottom-right corner calm and dark (logo). No airborne particles at all — the doves are perched, not in flight. No text, no letters, no watermark, no other people.
```
> **🔧 Revised 2026-09-12 (round 7):** hands/hair/color from round 6 held. Two new notes from the user: (1) the whole scene should read as fully photoreal, never cartoonish/stylized/illustrated — strengthened with an explicit "indistinguishable from a real photograph except for the glowing spirit" anchor; (2) doves frozen motionless in mid-air (as the §4 Flow loop had them) look physically wrong and read as fake/cartoonish even in a still — a real bird is either flying (with visible dynamic wing motion) or perched. Moved the doves onto the shrine roofline in a natural perched pose everywhere they appear (§0, §3, §3b, §3c, §4) — this is also simpler for the Flow loop, since a perched bird needs no special "frozen" framing at all. §3b (the 9:16 hero) had never been synced to rounds 1-6 and was rewritten to match §3 in full at the same time.
> **🇺🇦** Раунд 6 (руки/волосы/цвет) удержался. Два новых замечания: (1) вся сцена должна читаться как настоящая фотография, не мультяшно/стилизованно; (2) голуби, неподвижно висящие в воздухе (как было в лупе §4), выглядят физически неправдоподобно и мультяшно даже на стоп-кадре — реальная птица либо летит с видимой динамикой крыльев, либо сидит. Перенёс голубей на крышу храма во всех местах (§0, §3, §3b, §3c, §4) — так и лупу проще, сидящую птицу не нужно как-то специально "замораживать". §3b (вертикальный герой) вообще ни разу не синхронизировался с раундами 1-6 — переписан заново вместе с этим фиксом.
> **🔧 Revised 2026-09-11 (round 6):** color/density from round 5 held, but two OLDER fixes regressed in this batch: the spirit's head went bald again (round 3's fix), and a sword reappeared in the samurai's hand (round 2/3's fix) — a "whack-a-mole" pattern where fixing a new issue seems to loosen an older one, likely because the prompt has grown very long and the model's attention doesn't hold every constraint at once. Rewrote both trouble spots with more concrete, spatial/physical phrasing instead of more negations: the spirit's head now requires a specific silhouette shape (a topknot bump, not a smooth dome) instead of just "no bald," and the samurai's hands/swords are now described as two separate body zones with a physical height gap between them instead of just "not touching." **If this whack-a-mole pattern continues, the next step should be using the tool's follow-up-edit/chat feature to fix ONE specific flaw on an otherwise-good generation (e.g. "add a topknot to the spirit's head, it's bald") rather than re-rolling the whole scene from an ever-growing master prompt** — several of these image tools support that kind of targeted edit conversationally.
> **🇺🇦** Цвет/плотность из раунда 5 удержались, но откатились два СТАРЫХ фикса: у духа опять лысая голова (был исправлен в раунде 3), и меч опять оказался в руке самурая (раунды 2-3) — похоже на эффект "кротовьей норы", когда починка нового ломает старое, вероятно из-за того, что промт стал слишком длинным и модель не удерживает все ограничения разом. Переписал оба места через конкретную физическую/пространственную формулировку вместо очередного отрицания. **Если проблема повторится и дальше — вместо бесконечного раздувания промта стоит попробовать точечное редактирование через чат/follow-up самого инструмента** ("добавь пучок волос духу, он лысый") на уже неплохой картинке, а не перегенерировать всю сцену заново.
> **🔧 Revised 2026-09-11 (round 5):** round 4's shrine-life fix worked (lanterns, glowing windows, shimenawa all landed), but the spirit itself reads as pale white/marble-colored rather than warm gold, and its surface is flat and uniformly smooth like carved stone or a statue — visually contradicting "never a statue" even though the density fix (round 1) already worked. Pushed the color explicitly to honey-gold/amber (naming white/marble/porcelain/stone as the unwanted alternatives, same pattern that fixed the hair-texture issue in round 3), added uneven internal brightness so it reads as living light rather than a uniformly-lit sculpture, and asked for soft recognizable facial features instead of a blank glowing dome.
> **🇺🇦** Раунд 4 починил жизнь в храме, но сам дух остался бело-мраморным, а не тёплым золотым, и поверхность у него ровная и гладкая, как камень — визуально всё ещё читается как статуя, хотя плотность (раунд 1) уже была исправлена. Явно указал медово-золотой/янтарный цвет (перечислив мрамор/фарфор/камень как то, чем он НЕ должен быть — тот же приём, что починил волосы в раунде 3), добавил неровную внутреннюю яркость, чтобы это читалось как живой свет, а не равномерно освещённая скульптура, и попросил мягкие узнаваемые черты лица вместо гладкого купола.
> **🔧 Revised 2026-09-11 (round 4):** round 3 fixed hands/sword/hair, but the shrine itself read as an empty, lifeless ruin. Added three authentic Shinto details — warmly-lit hanging chōchin paper lanterns along the porch eaves, a warm interior glow through the lattice windows (suggests evening rites in progress), and a shimenawa sacred rope with shide streamers across the entrance — to give the building a sense of life without adding any new figures or clutter.
> **🇺🇦** Раунд 3 починил руки/меч/волосы, но сам храм выглядел пустым и безжизненным. Добавил три аутентичных синтоистских детали: тёплые подвесные фонарики тётин под карнизом, тёплое свечение изнутри через решётчатые окна (как будто идёт вечерний ритуал), симэнаву (священную верёвку) с бумажными полосками сидэ на входе — без новых фигур и без захламления кадра.
> **🔧 Revised 2026-09-11 (round 3):** round 2 fixed the sword-in-hand issue only partially (still happened ~50% of the time) and the "full head of hair" fix overcorrected into afro/dreadlock-textured hair on one or both figures. Round 3 explicitly locks hair texture as "straight, smooth, dark black" (ruling out curly/afro/braided/dreadlock as named alternatives, not just "no bald") on both the samurai and the spirit, and rewrites the hands/sword passage to describe physical separation — hands "well away from his hips," swords "undisturbed... completely untouched by either hand" — rather than only stating the negative ("no sword in hands"), since the repeated negative alone wasn't holding across every generation.
> **🇺🇦** Раунд 2 починил меч в руке лишь частично (через раз всё равно оставался), а "густые волосы" перегнулись в афро/дреды. Раунд 3: волосы теперь явно "прямые, гладкие, тёмные" (с явным перечислением того, чем они НЕ должны быть) у обеих фигур, а руки/меч переписаны через физическое расстояние ("руки далеко от бёдер", мечи "нетронуты ни одной рукой"), а не только через отрицание — одного "меча не в руках" оказалось мало.
> **🔧 Revised 2026-09-11 (round 2):** batch 2 fixed the density/warm-sky issues from round 1 but introduced three new problems: (1) a sword ended up in the samurai's own hand in at least one variant, despite the existing "no sword in hands" line — strengthened by explicitly separating "the samurai's hands" from "the spirit's bow" so the model doesn't conflate the two figures' weapons; (2) a bald patch/receding hairline appeared on the head (samurai and/or spirit) — added explicit "full head of hair, no bald spot" language to both figures; (3) the spirit was shown actively drawing/aiming the bow like a combat archer, reading as aggressive for a meditation channel — the bow is now explicitly "unstrung or slack, not drawn, not nocked, not aiming," and the whole scene is described as "calm and contemplative, not a battle or combat scene."
> **🇺🇦** Партия 2: меч оказался в руке самурая (усилил формулировку, разделив "руки самурая" и "лук духа", чтобы модель их не путала), появилась залысина (добавил явное требование густых волос без лысины у обеих фигур), дух держал лук в боевой стойке лучника — слишком агрессивно для медитативного канала (теперь лук explicitly "не натянут, не прицелен", сцена — "спокойная и созерцательная, не бой").
...
```
Photorealistic cinematic vertical still, 9:16, 4K, fully photoreal in every detail — NOT stylized, NOT cartoonish, NOT an illustrated or animated look, indistinguishable from a real photograph except for the glowing spirit itself. A lone samurai in dark weathered armor stands from behind, straight smooth dark black East Asian hair in a simple low topknot (chonmage-style) — NOT curly, NOT afro-textured, NOT braided, NO bald spot, NO bare scalp — no helmet, lower third, in a stone courtyard before an ancient Hachiman-zukuri shrine building at dusk — vermillion lacquered wood, dark cypress-bark roof, curved gabled porch, wide stone steps, a row of warmly-lit paper lanterns (chōchin) beneath the eaves, a warm glow from within visible through the lattice windows, a shimenawa rope with white shide streamers across the entrance, modeled on Usa Jingū. Above and behind him a colossal warrior-spirit takes shape out of the fading dusk light above the shrine roofline. The spirit's armored torso and face are dense and volumetric, filled with a warm HONEY-GOLD and AMBER light — explicitly NOT white, NOT marble, NOT porcelain-colored — with uneven, unevenly-glowing internal patches so it reads as living light rather than a flat statue. Its head's silhouette clearly includes a topknot bump at the crown, the same shape as the samurai below — NEVER a smooth bald dome. It holds a bow, sized naturally to its own body, resting calmly lowered at its side, unstrung, NOT drawn, NOT aimed, NOT stretched into a glowing arc — calm and contemplative, not a combat pose. Two or three real white doves perch calmly on the shrine roofline near the spirit, standing still in a natural resting pose with their feet visibly on the roof tiles — NOT hovering, NOT floating, NOT frozen mid-flight. The samurai's own arms hang straight down at his sides, hands clearly empty and well below his hip, a visible gap between his hands and his sword hilts — NOT touching, NOT gripping either sword. He wears dark tabi socks and straw waraji sandals — never barefoot. EXACTLY TWO swords — a katana and a shorter wakizashi — both fully sheathed at his LEFT hip only, thrust through the obi with the blade edge upward, hilts angled forward and up — never approached by either hand. NO third sword. Warm amber-gold dusk palette across the entire sky, fading to deep blue only at the very top edge — never a cool blue-dominant sky. The vermillion shrine walls glow warm in the last light. Keep the centre-left band calm and low-detail (a text overlay sits there). No airborne particles at all — the doves are perched, not in flight. No text, no letters, no watermark, no other people.
```

## §3c — Shorts image set (9:16 — 6 frames · FULL standalone prompts)

Save `hachiman-shorts-fr1.jpg … fr6.jpg`. No in-image text; bottom-right calm for logo. Frame 4 = calm zone for the 八幡 kanji overlay. No terrace railing anywhere. **🔒 Doves are perched on the shrine roofline, never in flight (locked 2026-09-12, matches §3/§3b)** — no airborne particles of any kind. Spirit's bow stays calmly lowered, never raised or drawn — calm vigil, not combat. Every samurai frame: EXACTLY TWO sheathed swords, thrust through the obi edge-up at the LEFT hip only, hilts forward, tabi + waraji, hands empty and well clear of the hilts.
**🇺🇦** Голуби сидят на крыше храма, никогда не в полёте — как в §3/§3b. Лук духа всегда опущен, не поднят и не натянут — спокойное бдение, не бой.
...
```
Photorealistic cinematic vertical close-up, 9:16, 4K, warm dusk light. A close view of a colossal warrior-spirit's armored torso and face, formed directly out of dense, volumetric honey-gold and amber light with uneven glowing patches — glowing plate-armor shapes suggested only by light and drifting mist, never a solid carved surface — one hand holding a bow of the same glowing light, calmly lowered and unstrung, never drawn or aimed, its expression calm and resolute. Its head's silhouette includes a simple topknot bump, never a smooth bald dome. Two faintly luminous white doves perch close by on a roof tile, at rest, never airborne. A living presence made of light, holding its form steady like a sculpture. Reverent, atmospheric, timeless. No text, no letters, no watermark.
```
...
```
Photorealistic cinematic vertical still, 9:16, 4K, warm amber-gold dusk palette, dramatic scale. A lone samurai in dark weathered armor stands from behind, hair in a simple topknot, no helmet, a calm still silhouette, centered in the lower third of a stone courtyard before an ancient Hachiman-zukuri shrine building at dusk — vermillion lacquered wood, dark cypress-bark roof, curved gabled porch, wide stone steps, modeled on Usa Jingū — only this one figure, no other people. Above and behind him the warrior-spirit's form is now fully resolved, its armored torso and face made of richer, warmer honey-gold light than before, its bow still calmly lowered at its side (never raised or drawn), two or three faintly luminous doves perched steadily on the roofline nearby, never airborne — a living presence, never a statue or mural. EXACTLY TWO swords — a katana and a shorter wakizashi — both fully sheathed at his LEFT hip only, thrust through the obi with the blade edge upward, hilts angled forward and up, never in front of him, never hidden. NO third sword. NO sword drawn. Hands empty at his sides. He wears dark tabi socks and traditional straw waraji sandals bound with cord at the ankle — never barefoot. Profound resolute stillness, the sense of a vow completed. No text, no letters, no watermark.
```
...
Feed the CLEAN hero (no text). Frame it as a **cinemagraph**. **🔒 Lock the spirit's ENTIRE visible shape — armored torso, face, and bow — like a sculpture, pixel-identical from the first frame to the last** (RYŪ lesson: a real/organic-looking shape drifts or reshapes over 8 sec unless explicitly frozen). **🔒 Doves perched on the shrine roofline, not flying (locked 2026-09-12, updated from an earlier "frozen mid-flight" draft that read as unnatural/uncanny — a bird motionless in mid-air with no sense of flight looks wrong even in a still, let alone a loop).** Perched birds are naturally static, so they're simply part of the frozen still like the samurai and the spirit's shape — no special "frozen" framing needed. Only the spirit's glow, the lantern flicker, and the sky may hold gentle, contained motion. **🔒 The glow must be described as ALREADY present from the first frame.**

```
A cinemagraph on a fully photorealistic warm dusk scene — NOT stylized, NOT cartoonish, NOT an illustrated look: a lone samurai in dark weathered armor stands from behind, hair in a simple topknot, no helmet, alone in a stone courtyard before an ancient Hachiman-zukuri shrine building — vermillion lacquered wood, dark cypress-bark roof, curved gabled porch, a row of warmly-lit paper lanterns (chōchin) beneath the eaves, a shimenawa rope across the entrance, modeled on Usa Jingū — and above him a colossal warrior-spirit made of dense, volumetric honey-gold and amber light — its armored torso, face and its bow, held calmly lowered at its side, already glowing steadily from the very first frame — with two or three faintly luminous white doves perched calmly on the shrine roofline nearby, feet resting on the tiles in an ordinary at-rest pose, exactly as real birds perch — never in flight, never hovering. Treat the samurai, his armor, his swords, the terrace, the doves, and the spirit's ENTIRE visible shape — armor, face, topknot silhouette, and lowered bow — as a completely frozen still photograph: every one of these stays locked pixel-identical in every single frame, never drifting position, never reshaping, never beating a wing. Camera completely locked and static — no pan, no zoom, no push-in, no dolly, no shake; the frame never moves. Animate ONLY these, all extremely subtle: (1) the spirit's light glows with a soft, continuous, gently pulsing honey-gold shimmer, its brighter and dimmer internal patches drifting very slowly, never changing the fixed shape of its armor or bow; (2) the hanging paper lanterns flicker with a faint, gentle warm inner light, like a real candle-flame flicker, without swinging or moving position; (3) the dusk sky in the far background — well away from the spirit's own silhouette — deepens by the faintest, barely perceptible degree, as if the very last moment of daylight is stretching out slowly. The air stays completely clear and calm the entire time. Everything solid — the samurai, the terrace floor, the spirit's fixed armored shape, the doves, the lantern positions, the shrine architecture — stays a completely frozen photograph. Slow, warm, resolute, meditative. Only the light's glow, the lanterns' flicker, and the sky's faint deepening move at all, in a smooth continuous cycle so the last frame matches the first frame exactly, pixel-for-pixel in every fixed element including the spirit's full silhouette and the doves' frozen positions, for a perfectly seamless 8-second loop.
```
**🇺🇦** Голуби теперь тоже часть неподвижного кадра — застыли в полёте, как на фотографии, крыльями не машут. Живут только: (1) свечение духа мягко пульсирует медово-золотым, (2) фонарики тётин мерцают как живое пламя свечи, не раскачиваясь, (3) едва заметное углубление сумеречного неба вдалеке. Камера статична, последний кадр = первый.
