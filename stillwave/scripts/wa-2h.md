...
> ⚠️ **Ripple attempt failed twice on Veo 3 / Flow (2026-08-14).** Veo 3 ties ANY water "ripple" to the monk and generates concentric rings radiating from him — even with explicit "no rings / uniform shimmer" wording. **Fix: frame it as a CINEMAGRAPH — everything is a frozen still photograph, only the mist moves; the water is a perfect glass mirror.** A still mirror is on-brand for 和 (perfect symmetry) and rules out rings entirely. Veo 3 responds strongly to the word "cinemagraph". Use this prompt:

```
A cinemagraph. The entire image is a completely frozen still photograph and NOTHING moves except a thin mist — treat every solid object and the whole water surface as a frozen photo. Camera completely locked and static — no pan, no zoom, no push-in, no dolly, no shake; the frame never moves. From the very first frame a thin low mist is ALREADY present over the water and already drifting — it does not start or appear. The pond is a PERFECTLY STILL, FROZEN GLASS MIRROR: the water surface does NOT move at all — no ripples, no waves, no rings, no circles, no shimmer anywhere — and its reflection is a flawless frozen mirror image that never changes. Animate ONLY the thin mist drifting slowly and continuously just above the water, plus an almost imperceptible breath of warm dawn light. The monk, the stone, the maple, the lantern, the far bank AND the entire water surface stay completely frozen like a photograph — only the mist drifts. The light does not change colour or overall brightness, does not shift time of day. Slow, warm, balanced, meditative. The mist moves in a smooth continuous cycle so the last frame matches the first frame exactly for a perfectly seamless 8-second loop.
```
