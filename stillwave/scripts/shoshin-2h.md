# SHOSHIN — 初心 | Japanese Zen Music for a Beginner's Mind, Clarity & Fresh Focus

## Meta

- **Series:** Kanji-Concept (Japanese Zen)
- **Slug:** shoshin-2h
- **Concept:** 初心 (shoshin) — "beginner's mind." Meeting each moment fresh, without the weight of expertise. Clarity, openness, fresh focus.
...
## §1 — Suno prompts (10 copy-paste variants — fresh, clear, open, ametric)
...
[opening: a single crystal singing bowl strike, long bright shimmering decay, then a soft luminous drone rises]
[section A: breathy shakuhachi long tones enter far away, open and calm]
[section B: the drone brightens, the bowl returns once, everything floats]
[section C: shakuhachi thins, only the bright drone and a last bowl remain]
[loop point: the final bowl decay dissolves back into the opening drone]
[mood: dawn light spreading over a misty valley, the mind fresh and unhurried]
[texture: clear, bright, spacious, weightless]
```
...
[section B: a soft bright pad swells softly under the koto]
[section C: the bell tolls once more, distant, everything settles]
[loop point: the last resonance fades into the first bell]
[mood: a temple courtyard at first light, dew on the stones]
[texture: clear, open, patient, bright reverberation]
```
...
[no lyrics, no vocals, instrumental only]
[no drums, no percussion, no beat, no tempo — free time, every note floats and decays on its own]
[opening: a slow swelling bright warm drone pad alone, no melody for the first eight seconds]
[section A: a soft distant flute drifts in, long held notes]
[section B: the pad widens, a faint singing bowl shimmer appears]
[section C: flute recedes, the bright pad breathes alone]
[loop point: the pad's swell returns seamlessly to the start]
[mood: standing in soft morning light, nothing yet decided, everything open]
[texture: soft, wide, luminous, weightless]
```
...
[no lyrics, no vocals, instrumental only]
[no drums, no percussion, no beat, no tempo — free time, every note floats and decays on its own]
[opening: three or four sparse bright koto notes, never a repeating pattern, long silences]
[section A: a soft pad swells underneath the koto]
[section B: distant breathy shakuhachi answers the koto, open and calm]
[section C: the koto slows, notes further apart, the pad holds]
[loop point: the last koto note decays into the opening silence]
[mood: a still room, a window open to the first light, a fresh page]
[texture: clear, bright wood, spacious silence]
```
...
[no lyrics, no vocals, instrumental only]
[no drums, no percussion, no beat, no tempo — free time, every note floats and decays on its own]
[opening: a breathy shakuhachi long open tone from the second second, calm and clear]
[section A: bright warm drone pad glows beneath the flute]
...
[mood: a first clear breath at dawn, the mind uncluttered]
[texture: airy, bright, breath-like, spacious]
```
...
[no lyrics, no vocals, instrumental only]
[no drums, no percussion, no beat, no tempo — free time, every note floats and decays on its own]
[opening: five seconds of soft clear morning air with very faint distant birdsong, no instruments]
[section A: a bright singing bowl and a soft drone enter softly]
[section B: a koto answers far away, never a repeating pattern]
[section C: the instruments thin out, only air and drone remain]
[mood: a valley waking under the first light, mist lifting]
[texture: airy, distant, clear, open]
```
...
[no lyrics, no vocals, instrumental only]
[no drums, no percussion, no beat, no tempo — free time, every note floats and decays on its own]
[opening: a soft harp, single bright notes with long gaps, never a repeating pattern]
[section A: a warm pad swells slowly beneath the harp]
[section B: a distant flute drifts over the top, long held notes]
[section C: the harp slows, the pad glows bright and wide]
[loop point: the last harp note dissolves into the opening pad]
[mood: light spreading across a clean quiet room, a fresh start]
[texture: soft, luminous, weightless, bright]
```
...
[no lyrics, no vocals, instrumental only]
[no drums, no percussion, no beat, no tempo — free time, every note floats and decays on its own]
[opening: soft sustained strings swell in slowly, like a first calm morning breath]
[section A: a distant shakuhachi answers the strings, open and clear]
[section B: a faint bright singing bowl shimmers, the strings widen]
[section C: the strings settle warm and clear, the flute fades]
[loop point: the strings' swell returns seamlessly to the start]
[mood: a wide sky lightening at dawn, the heart unhurried and open]
[texture: warm, bright, enveloping, slow]
```
...
[section A: a bright warm pad glows beneath the piano]
...
[mood: first light on a bare wooden floor, a fresh clear beginning]
[texture: intimate, clear, soft-hammered, spacious]
```
...
[no lyrics, no vocals, instrumental only]
[no drums, no percussion, no beat, no tempo — free time, every note floats and decays on its own]
[opening: a small rin bell bright shimmer, a soft warm drone rising slowly beneath it]
[section A: koto notes drift far away, never a repeating pattern, long gaps]
[section B: the drone brightens, the rin returns once, everything floats]
...
[mood: a fresh clear dawn, the first thought of the day, unclouded]
[texture: clear, warm, shimmering, weightless]
```
...
```
Photorealistic cinematic vertical still 9:16, 4K, high contrast. A dark Japanese temple tea room, a lone Buddhist monk in dark robes seated in seiza from behind, lower third, near-silhouette, facing a single large perfectly round marumado window. The window is set in a plain, smooth, unbroken earthen-plaster wall — the wall on both sides is completely flat and bare, no shoji screens, no sliding doors, no wooden lattice panels, no other openings, only the round window in a solid wall. Through the circle: a vivid autumn garden — a glowing crimson-and-gold Japanese maple, fallen leaves on green moss, gentle mist, soft warm morning light. The bright circular autumn view glows against the dark interior. Keep the centre-left band calm and low-detail (a text overlay sits there). No text, no letters, no watermark.
```
> 🔒 **NO shoji / sliding doors / shutters anywhere** (user pref 2026-08-11) — the round window sits in a plain solid wall; both sides bare. NanoBanana adds shoji by default, so this must be stated on every window frame.
...
1. **HOOK — monk before the glowing round window:** `Photorealistic cinematic vertical still, high contrast, a lone Buddhist monk in dark robes seated in seiza from behind in a dark temple room, near-silhouette, facing a single large round marumado window set in a plain smooth unbroken earthen-plaster wall, bare flat wall on both sides, no shoji screens, no sliding doors, no lattice panels, only the round window in a solid wall, the circle glowing with a vivid crimson-and-gold autumn maple garden in soft warm light. No text, no watermark. 4K.`
...
6. **monk before the round window, wide (wisdom):** `Photorealistic cinematic vertical still, high contrast, a lone monk in dark robes seated in seiza from behind in a dark temple room facing a single round marumado window set in a plain smooth unbroken earthen-plaster wall (bare on both sides, no shoji, no sliding doors, no lattice panels, only the round window in a solid wall), the circle glowing with an autumn maple garden, warm light spilling into the dark room, deeply calm, only the one seated monk, no other people. No text, no watermark. 4K.`
...
- Line 1 (kanji): **初心忘るべからず**
- Line 2 (romaji): *Shoshin wasuru bekarazu*
- Line 3 (gloss): Never forget the beginner's mind
- Cream `#F5EAD2`, Liberation Serif Bold, LEFT-lower over the dark veranda/wood zone. 0:00–0:03 scene only → fade-in 2s → hold ~5s → fade-out 2s (ends 0:14).
- **🇺🇦** Мудрость: **初心忘るべからず** / *Shoshin wasuru bekarazu* / «Никогда не забывай ум новичка» — знаменитая фраза Дзэами, ровно под тему. Слева-внизу, кремовым. (8 иероглифов — рендерю чуть меньшим кеглем, чтобы влезло.)
...
SHOSHIN — 初心 | Japanese Zen Music for a Beginner's Mind, Clarity & Fresh Focus
```
(`Music` by char ~30 ✅ · ≤90 ✅ · no hashtags)

**A/B:** `SHOSHIN — 初心 | Japanese Zen Music to Return to a Beginner's Mind & Fresh Clarity`
...
```
japanese zen music, meditation music, zen music, focus music, calming music, relaxing music, healing music, ambient music, beginner's mind, shoshin, music for clarity, music for fresh focus, koto music, shakuhachi flute, singing bowls — a two-hour Japanese zen session for a clear beginner's mind.

🌀 SHOSHIN (初心) means "the beginner's mind."
To meet this moment as if for the first time —
open, unhurried, free of what you think you know.
...
```
stillwave, japanese zen music, meditation music, zen music, focus music, calming music, relaxing music, healing music, ambient music, beginner's mind, shoshin, music for clarity, music for fresh focus, koto music, shakuhachi flute music, singing bowl music, japanese meditation music, mindfulness music, zen meditation music, a lone monk on a temple veranda at dawn as the sun rises through valley mist, joe hisaishi
```
...
- Build from hero via `shoshin-compose-thumb.py` (clone of the KOKORO composer).
- **初心** molten gold, upper-centre over the open dawn sky (beside/above the sun disc — never over the sun's centre if it reads as a face-like focal point; keep it clean) + dark halo for legibility.
- **SHOSHIN** — large gold Liberation Serif Bold (legible — NOT the brush font), low, centred on the dark veranda with a soft scrim. (Same legible-serif treatment locked on KOKORO/KOMOREBI 2026-08-07.)
...
```
🌀 SHOSHIN (初心) — the beginner's mind. "In the beginner's mind there are many possibilities; in the expert's mind there are few." 🌅 What would you begin again if you met it fresh? Subscribe for more Japanese ambient meditation journeys 🌿
```
...
```
SHOSHIN (初心) in Japanese Culture: A Concise Overview

初心 (shoshin) means "beginner's mind" — the openness and freshness a beginner brings, unclouded by the assumptions of expertise. It runs from the Noh master Zeami's warning 初心忘るべからず ("never forget the beginner's mind") to the Zen teacher Shunryu Suzuki, whose Zen Mind, Beginner's Mind carried the idea worldwide: "In the beginner's mind there are many possibilities, in the expert's mind there are few." To practice shoshin is to meet each moment as if for the first time. Here a lone monk sits on a temple veranda as the dawn sun rises through the valley mist — a new day, met fresh.
```
...
Built from the 6 frames (§3c) via `shoshin-short-build.py` + `shoshin-short-overlays.py` (Ken Burns float-precision PIL, crossfades, gold beats) — same pipeline as KOKORO. Three gold beats, all inside the safe zone (y 150-1450, x 60-880 of 1080×1920):
- **Beat 1 (hook):** `Meet this moment as the first` (cream)
- **Beat 2 (concept, frame 4):** `初心` + `SHOSHIN` (gold, upper open-sky zone)
- **Beat 3 (wisdom):** `初心忘るべからず` + `Shoshin wasuru bekarazu` + `Never forget the beginner's mind` (gold, lower)

### 📋 Shorts — copy-paste pack

**Title**
```
What Is Shoshin? The Zen Idea of a Beginner's Mind 🌅 #shorts
```
**A/B Title**
```
Shoshin — Meet Every Moment as the First 🌅 #shorts
```
**Description**
```
初心 Shoshin — "the beginner's mind." To meet this moment as if for the first time, open and unclouded by what you think you know.

初心忘るべからず — never forget the beginner's mind.

Full 2-hour Japanese zen session on the channel 🌿

#shoshin #japanese #zen #meditation #shorts
```
**Tags**
```
shoshin, what is shoshin, beginner's mind, shoshin meaning, japanese words, zen mind beginner's mind, japanese philosophy, zen, meditation, clarity, fresh focus, stillwave
```
**Pinned comment**
```
🌀 初心 SHOSHIN — the beginner's mind. Full 2-hour session on the channel 🌿
```

Settings: **Not for kids** · playlist **StillWave Shorts** · Related video → long-form SHOSHIN.
